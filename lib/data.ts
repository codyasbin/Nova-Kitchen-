...
const products = [
  // Modular Kitchens
  {
    ...
    description: 'A luxury L-shaped kitchen design featuring premium materials, advanced storage solutions, and a sophisticated aesthetic. Perfect for modern homes that prioritize both functionality and style.',
    specifications: [
  ...
  },
  {
    ...
    description: 'This parallel kitchen design maximizes efficiency with two facing work areas, perfect for homes where space utilization is key. Features sleek finishes and optimized workflow placement.',
    specifications: [
      'Dimensions: Customizable',
  ...
  },
  {
    ...
    description: 'A statement island kitchen that combines functionality with social entertaining space. The centerpiece island provides additional workspace, storage, and seating, perfect for modern open-plan living.',
    specifications: [
  ...
  // Appliances - Chimneys
  {
    ...
    description: 'An elegant, powerful auto-clean chimney with advanced filtration technology, designed to keep your kitchen smoke and odor-free while adding a touch of sophistication to your space.',
    specifications: [
  ...
  },
  {
    ...
    description: 'A stylish curved glass chimney that combines powerful suction with elegant aesthetics. The curved design enhances both functionality and visual appeal in modern kitchens.',
    specifications: [
  ...
  // Appliances - Gas Stoves
  {
    ...
    description: 'A premium 5-burner gas stove featuring high-efficiency brass burners, toughened glass top, and ergonomic design. Perfect for large families and those who love to cook multiple dishes simultaneously.',
    specifications: [
  ...
  // Water Purifiers
  {
    ...
    description: 'The Kent Grand Plus offers multiple purification stages including RO, UV, and UF to provide 100% pure water. Its mineral retention technology ensures the water remains healthy and mineral-rich.',
    specifications: [
  ...
  },
  {
    ...
    description: 'The ZeroB Pristine offers advanced 6-stage purification with intelligent mineral adjustment to ensure healthy, great-tasting water. Featuring smart indicators and alerts for maintenance.',
    specifications: [
  ...
  // Air Conditioners
  {
    ...
    description: 'The Voltas Inverter Split AC offers efficient cooling with significant energy savings. Features multiple operating modes and smart temperature control for optimal comfort.',
    specifications: [
      'Capacity: 1.5 Ton',
...
export const getFeaturedProducts = () => {
  return products.filter(product => product.bestseller || Math.random() > 0.5).slice(0, 8);
};
